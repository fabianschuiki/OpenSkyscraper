...
vector<string> Application::resourcesPaths()
{
	vector<string> paths;
	paths.push_back(".");
...
string Application::pathToResource(string resourceName)
{
...
string Application::pathToResource(string resourceGroup, string resourceName)
{
