...
MACRO(FIND_PATH_HELPER FILENAME DIR SUFFIX)
   ...
   IF(NOT ${FILENAME}_DIR)
      MESSAGE("Could not locate ${FILENAME}")
      SET(CEGUI_FOUND "NO")
   ELSE()
...
FOREACH(COMPONENT ${CEGUI_FIND_COMPONENTS})
   ...
   string(TOLOWER ${COMPONENT_CASE} COMPONENT_LOWER)
   FIND_PATH_HELPER( "${COMPONENT_LOWER}renderer.h" "CEGUI_INCLUDE_SEARCH_DIR" "CEGUI/RendererModules/${COMPONENT_CASE}GUIRenderer/;RendererModules/${COMPONENT_CASE}GUIRenderer/" )
